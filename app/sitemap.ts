...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    {
      url: `${base}/tools/google-maps-reviews`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
    ...
    {
      url: `${base}/tools/tripadvisor-reviews`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
    ...
    {
      url: `${base}/tools/tiktok-profile-videos`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
      url: `${base}/tools/meta-ads-library`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
      url: `${base}/tools/x-profile-posts`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
      url: `${base}/tools/facebook-pages`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
      url: `${base}/tools/website-contact-details`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
